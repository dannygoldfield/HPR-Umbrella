#!/usr/bin/env python3
"""Render and register a controlled film-grain character/strength comparison."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-root",
        type=Path,
        default=REPOSITORY_ROOT / "workspace/film-grain-composite-v21",
    )
    parser.add_argument(
        "--config",
        type=Path,
        default=REPOSITORY_ROOT
        / "components/video-generator/config/film-grain-composite-recipes.json",
    )
